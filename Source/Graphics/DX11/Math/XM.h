...
struct XMatrix
{
	static FORCEINLINE DirectX::XMFLOAT3 GetEulerAngles(const DirectX::XMFLOAT4X4& mat)
	{
	...
	static FORCEINLINE DirectX::XMFLOAT3 GetTranslation(const DirectX::XMFLOAT4X4& matrix)
	{
