...
{
public:
	static IndexedTriangleList MakeTesselatedTextured(DynamicVtx::VertexLayout layout, int divisions_x, int divisions_y)
	{
		...
		indices.reserve(WGMath::Multiply(divisions_x * divisions_y) * 6);
		{
